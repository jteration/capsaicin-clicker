export default function(state, action) {
  ...
  const twoEvents = [
    { event: "A wandering cat ate one of your pepper plants. -1 plant.", lowerChance: 1, higherChance: 50, effect: function(){if(action.payload.game.plants >= 1){action.payload.game.plants -= 1}}},
    ...
    { event: "A passerby hears you sing a song while tending to your peppers and is impressed. He swears fealty to you. +1 Gardener", lowerChance: 700, higherChance: 775, effect: function(){action.payload.game.helpers.purchasedHelpers.Gardeners += 1} },
  ...
  const fourEvents = [
    { event: "A wandering brontasaurus ate some of your pepper plants. -10 plants.", lowerChance: 1, higherChance: 25, effect: function(){if(action.payload.game.plants >= 10){action.payload.game.plants -= 10}}},
