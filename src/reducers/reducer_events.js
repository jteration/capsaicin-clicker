export default function(state, action) {
  ...
  const fourEvents = [
    ...
    { event: "Your hottest pepper won best in show. You've attracted the help of a local gardner. +1 gardner", lowerChance: 210, higherChance: 230, effect: function(){action.payload.game.helpers.purchasedHelpers.Gardners += 1}},
  ];
  const tenEvents = [
    ...
    { event: "A wandering rogue has stolen your hottest pepper! -20% heat.", lowerChance: 110, higherChance: 115, effect: function(){action.payload.game.capsaicin *= 0.2}},
  ...
  const hundredEvents = [
    { event: "During lunch you performed the heimlich maneuver on who turned out to be the director of pepper agriculture for your state. He allots you ten experimental aquaponics facilities for saving his life. +10 aquaponics.", lowerChance: 1, higherChance: 30, effect: function(){action.payload.game.helpers.purchasedHelpers.Aquaponics += 10}},
