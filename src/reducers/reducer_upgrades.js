export default function(state, action) {
  ...
  let upgrades = [
    ...
    {upgrade: 'assembly_line', text:'4000 Heat - Adding assembly lines to your glass factory increases the efficiency ten fold', capsaicinCheck: 4000, purchased: false},
    ...
    {upgrade: 'kheech_and_khong', text:'420000 Heat - You hire local experts Kheech and Khong to help set up new greenhouses. Greenhouse generation increases five fold', capsaicinCheck: 420000, purchased: false},
