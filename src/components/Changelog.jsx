		...
		return (
			<div className="cell medium-6 small-12" style={{ height: 400 }}>
				<div className="card medium-cell-block-y" style={{ height: 400 }}>
					<h3>Changelog</h3>
					<br />
					<span>Changelog Dec 5th 9:55pm</span>
					<br />
					<span>Added a button to toggle the chat window</span>
					<br />
					...
					<br />
					<span>
						Function that determined the species was trying to read a non
						existent array value when you were on the final one. You should now
						be able to become the last species
					</span>
					<br />
					...
					<span>-Events</span>
					<span>
						Nerfed chances of wandering rogue event (-20% heat). Was 5/10000
						chance every 2.5 seconds now 1/10000 chance (I got this like twice
						in a row wtf)
					</span>
					<span>
						Nerfed chances of pepper blight (-50% plants -30% heat). Was
						20/10000 chance every 25 seconds now 1/10000 chance every 250
						seconds
					</span>
					...
					<br />
					<span>
						Madagascar upgrade increases production ten fold instead of doubling
					</span>
					...
					<span>
						Second Madagascar upgrade at 1000000000 heat. Increases production
						by 100x
					</span>
					<br />
					...
					<span>-Events</span>
					<span>
						Nerfed the chance of the tap on the back event since it was
						appearing too often
					</span>
					<br />
					<span>-Helpers</span>
					...
					<span>
						If you buy Madagascar it will show as purchased and the button will
						turn gold
					</span>
					<br />
					<span>-Upgrades</span>
					...
					<span>
						Halves the gardener requirement on purchasing including the
						automated purchasing
					</span>
					<br />
					<span>
						This update shouldn't reset your game. If it does I'll make it up
						somehow
					</span>
					<br />
					<span>
						Mini-update - Chat should load in the correct order now on page load
					</span>
					<br />
					...
					<span>
						-Madagascar - costs 100 pepper forests and 1,000,000 heat. Generates
						20,000,000 plants per second. You can only have one of these.
					</span>
					<br />
					<span>-Added new upgrades</span>
					<span>
						-Min/Max Madagascar - costs 250,000,000 heat, You min/max Madagascar
						doubling pepper production there.
					</span>
					<span>-Click x10 modifier for 10,000 heat</span>
					<br />
					<span>-Added new events</span>
					<span>
						-Added super extra rare event you have .01% chance of this happening
						every 1250 seconds
					</span>
					<br />
					...
					<span>-Added new events</span>
					<span>
						-Added an extra rare event category rolling once every 250 seconds
					</span>
					<br />
					<span>-Added new helper</span>
					<span>
						-Pepper forests - costs 1000 farms and 50,000 heat. Generates 50,000
						plants per second.
					</span>
					<br />
					<span>-Added new upgrades</span>
					<span>
						-Assembly Lines -15000 Heat. Adding assembly lines to your factories
						increases the efficiency ten fold
					</span>
					<span>
						-Mass Recruiting - 50000 Heat. A global recruitment push brings one
						hundred gardeners to your employment per second but at quadruple
						cost
					</span>
					<span>
						-Genetic Modifying - 2500000 Heat. You hire scientists to look into
						modifying your pepper's genetic code directly. Your heat grows twice
						as fast.
					</span>
					<span>
						-Better Forests - 100000000 Heat. Double effectiveness of pepper
						forests
					</span>
